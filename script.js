...
//a = new CELL(0,0,[true, false, false, true],false,false)
//console.log(MyLaby.getCellsAroundLaby(a))
// console.log(MyLaby.caseACoteeLaby(1,1,MyLaby.cells[0]))
// console.log(a.caseCheckedCell())
